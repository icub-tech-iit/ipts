...
echo;
echo;
"%PATH%\STMicroelectronics\STM32 ST-LINK Utility\ST-LINK Utility\ST-LINK_CLI.exe" -c -P "..\..\icub-firmware-build\ETH\MC4PLUS\bin\environment\mc4plusLoader.hex"
echo;
echo;
"%PATH%\STMicroelectronics\STM32 ST-LINK Utility\ST-LINK Utility\ST-LINK_CLI.exe" -c -P "..\..\icub-firmware-build\ETH\MC4PLUS\bin\environment\mc4plusUpdater.hex"
echo;
echo;
