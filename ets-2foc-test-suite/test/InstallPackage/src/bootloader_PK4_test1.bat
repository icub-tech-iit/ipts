...
"C:\Program Files\Microchip\MPLABX\v6.15\mplab_platform\mplab_ipe\ipecmd.exe" -TPPK3 -P33FJ128MC802 -E -M -Fbootloader1.hex -OL
goto END

:TPPK4
REM Commands for TPK4
echo Using  TPK4 programmer
"C:\Program Files\Microchip\MPLABX\v6.15\mplab_platform\mplab_ipe\ipecmd.exe" -TPPK4 -P33FJ128MC802 -E -M -Fbootloader1.hex -OL
goto END
